...
import fr.climbing.service.TopoServiceImpl;
import fr.climbing.service.UserService;
import fr.climbing.service.UserServiceImpl;
 
@Configuration
@ComponentScan("fr.climbing.*")
...
public class ApplicationContextConfig {
 ...
 public SessionFactory getSessionFactory(DataSource dataSource) throws Exception {
     ...
     factoryBean.setPackagesToScan(new String[] { "fr.climbing.*" });
