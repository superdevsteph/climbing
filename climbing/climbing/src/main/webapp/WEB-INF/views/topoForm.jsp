...
<html lang="en">
<style><%@include file="/resources/css/style.css"%>
</style>
	...
	<nav class="navbar navbar-expand-sm   navbar-light bg-light fixed-top">
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
				...
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/infos">About</a></li>
				<li class="nav-item dropdown dmenu"><a
					class="nav-link dropdown-toggle" href="#" id="navbardrop"
					data-toggle="dropdown"> Espace membre </a>
					<div class="dropdown-menu sm-menu">
						<a class="dropdown-item"
							href="${pageContext.request.contextPath}/login">Se connecter</a>
						<a class="dropdown-item"
							href="${pageContext.request.contextPath}/registration">Créer
							un compte</a>

					</div></li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/topoList">Les topos</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/contact">Nous
						contacter</a></li>
				<li class="nav-item dropdown dmenu"><a
					class="nav-link dropdown-toggle" href="#" id="navbardrop"
					data-toggle="dropdown"> Articles récents </a>
					<div class="dropdown-menu sm-menu">
						<a class="dropdown-item"
							href="${pageContext.request.contextPath}/articles">Article 1</a>
						<a class="dropdown-item" href="#">Article 2</a> <a
							class="dropdown-item" href="#">Article 3</a> <a
							class="dropdown-item" href="#">Article 4</a> <a
							class="dropdown-item" href="#">Article 5</a> <a
							class="dropdown-item" href="#">Article 6</a>
					</div></li>
			</ul>
		...
		<form:form class="form-horizontal my-5 center_div col-6" role="form"
			action="saveTopo" method="POST" modelAttribute="userForm">
				...
				<div class="form-group col-10">
					...
					<form:input class="form-control" path="region" required="required" />
					<form:errors path="region" class="error-message" />
				</div>
